...
import com.mitrais.bootcamp.helper.GZipUtilities;
...
public class GZipServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GZipServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GZipServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
// whether or not gzip is supported.
        ...
        out.println(
                "<HTML>\n"
                + "<HEAD><TITLE>Sending Compressed Pages</TITLE></HEAD>\n"
                + "<BODY BGCOLOR=\"#FDF5E6\">\n"
                + "<H1 ALIGN=\"CENTER\">Sending Compressed Pages</H1>\n");
